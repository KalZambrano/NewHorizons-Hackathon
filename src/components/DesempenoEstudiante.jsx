...
const getRango = (puntos) => {
  if (puntos >= 90) return 'Excelente (90–100)';
  if (puntos >= 80) return 'Bueno (80–89)';
  if (puntos >= 70) return 'Intermedio (70–79)';
  if (puntos >= 60) return 'Bajo (60–69)';
...
const DesempenoEstudiante = ({ estudiantes, estudianteActual, onClose }) => {
  // Agrupamos los estudiantes por rango
  const rangos = [
    'Excelente (90–100)',
    'Bueno (80–89)',
    'Intermedio (70–79)',
  ...
  estudiantes.forEach(e => {
    const r = getRango(e.puntos);
    conteoPorRango[r]++;
  });

  const rangoEstudiante = getRango(estudianteActual.puntos);
